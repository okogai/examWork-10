...
export const selectNewsListLoading = (state: RootState) =>
  state.news.fetchingNewsListLoading;
export const selectFullNewsLoading = (state: RootState) =>
  state.news.fetchingOneNewsLoading;
export const selectAddNewsLoading = (state: RootState) =>
  state.news.addNewsLoading;
